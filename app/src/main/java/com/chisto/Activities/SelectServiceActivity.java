        ...
        findViewById(R.id.cont_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(adapter.getSelected().size() != 0) {
                    ...
                    OrderList.changeColor(getIntent().getIntExtra("color", Color.parseColor("#212121")));
            ...
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                ...
                if(response.isSuccessful()) {
                    ...
                    collection.add(new Treatment(
                            ...
                            "Декор",
                            "Описание",
                            getIntent().getBooleanExtra("decor", false)));
                    ...
                    if(OrderList.getTreatments() != null) {
                        ...
                        for (int i = 0; i < collection.size(); i++) {
                            for (int j = 0; j < OrderList.getTreatments().size(); j++) {
                                if (collection.get(i).getId() == OrderList.getTreatments().get(j).getId()) {
                                    collection.get(i).setSelect(true);
                                    continue main_loop;
                                }
                            }
                        }
