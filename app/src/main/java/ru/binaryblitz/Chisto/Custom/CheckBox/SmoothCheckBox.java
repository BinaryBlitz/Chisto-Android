package ru.binaryblitz.Chisto.Custom.CheckBox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_UNCHECKED = Color.parseColor("#eaeaea");
    private static final int COLOR_CHECKED = Color.parseColor("#4bc2f7");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#eaeaea");
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, AndroidUtilities.INSTANCE.dpToPx(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = AndroidUtilities.INSTANCE.dpToPx(getContext(), DEF_DRAW_SIZE);
