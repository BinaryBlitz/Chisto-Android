...
data class Laundry(val id: Int, val icon: String, val name: String, val desc: String, val rating: Float, val collectionDate: Date?,
                   ...
                   val orderCost: Int?, val index: Int?, val decorationMultipliers: ArrayList<android.support.v4.util.Pair<Int, Double>>?,
                   val deliveryFee: Int?, val freeDeliveryBound: Int?)
